...
public class QuanLyNguoiDungFrame extends javax.swing.JFrame {
    ...
    private  boolean kiemTraKhongRong(){
        ...
        if(jTextFieldDiem.getText().isEmpty()){
    ...
    private void clear() {
        ...
        this.khDAO.loadData(jTableKhachHang);
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextFieldDiem, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 410, 350, -1));
        ...
        jPanel2.add(jDateChooserNgaySinh, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 460, 180, -1));

        jDateChooserNgayDangKy.setDateFormatString("dd/MM/yyyy");
        jPanel2.add(jDateChooserNgayDangKy, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 520, 180, -1));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel9.setText("Ngày sinh");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 440, -1, -1));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel10.setText("Ngày đăng ký");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 500, -1, -1));
        ...
        jTableKhachHang.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID ", "Họ và tên", "Địa chỉ", "Số điện thoại", "Ngày sinh", "Ngày đăng ký", "Điểm"
            }
        ) {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Họ Tên", "SĐT" }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        jPanel2.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 620, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/anh-nen-lam-slide_023656040.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, 1120, 730));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        double diem=Double.valueOf(jTextFieldDiem.getText());
    ...
    private void jButtonTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTimKiemActionPerformed
        ...
        if(this.jComboBox1.getSelectedItem().toString().equals("ID") && !this.jTextFieldTuKhoa.getText().equals("")) this.khDAO.searchForID(Integer.parseInt(this.jTextFieldTuKhoa.getText()),this.jTableKhachHang);
        if(this.jComboBox1.getSelectedItem().toString().equals("SĐT")) this.khDAO.searchForSDT(this.jTextFieldTuKhoa.getText(),this.jTableKhachHang);
        if(this.jComboBox1.getSelectedItem().toString().equals("Họ Tên")) this.khDAO.searchForName(this.jTextFieldTuKhoa.getText(),this.jTableKhachHang);
    ...
    private void jTableKhachHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableKhachHangMouseClicked
        ...
        String ngaySinhString = model.getValueAt(r, 4).toString();
        String ngayDangKyString = model.getValueAt(r, 5).toString();
        if (model.getValueAt(r, 6)==null) {
            jTextFieldDiem.setText("");
        } else {
            jTextFieldDiem.setText(model.getValueAt(r, 6).toString());
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        if (kiemTraKhongRong()) {
            ...
            if (!khDAO.kiemTraIDKhongDuocThayDoi((KhachHang) kh)) {
                khDAO.update((KhachHang) kh);
                QuanLyNguoiDungFrame ql = new QuanLyNguoiDungFrame();
                ql.setVisible(true);
                ql.pack();
